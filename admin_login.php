...
<div class="auth-wrapper">
    <div class="auth-card glass animate-fade-in">
        <div class="auth-header">
            <div class="portal-icon" style="font-size: 3rem; margin-bottom: 10px;"><i class="fas fa-user-shield"></i></div>
            <h1 class="gradient-text">Admin Login</h1>
            <p style="color: var(--text-dim)">Access administrative controls</p>
        </div>
        ...
        <div style="margin-top: 30px; text-align: center; font-size: 0.85rem; color: var(--text-dim);">
            <p>Don't have an admin account? <a href="admin_register.php" style="color: var(--primary); text-decoration: none; font-weight: 600;">Register here</a></p>
